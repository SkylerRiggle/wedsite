  ...
  return (
    <div className='solid-background' id='faq'>
      ...
      <div className='dual-column' style={{paddingTop:'20px'}}>
        ...
        <div className='q-card'>
          <p className='dark'>Should I match the wedding colors/What are the wedding colors?</p>
          <p style={{lineHeight:'10pt'}}>-</p>
          <p style={{padding:'2%'}}>You do not have to match our colors! If you'd like to wear matching colors, our colors are reds, yellows, pinks, and greens. </p>
        </div>
      </div>

      <div className='dual-column' style={{paddingTop:'20px'}}>
        <div className='q-card'>
          <p className='dark'>Where do I park?</p>
          <p style={{lineHeight:'10pt'}}>-</p>
          <p style={{padding:'2%'}}>Parking can be around the park or in the water park parking lot across the street from the venue.</p>
        </div>

        <div className='q-card'>
          <p className='dark'>Can I get a digital save-the-date?</p>
          <p style={{lineHeight:'10pt'}}>-</p>
          <p style={{padding:'2%'}}>Yes! If you go to our Engagement Photos link, you can access the save-the-date there!</p>
        </div>
      </div>

      <div className='dual-column' style={{paddingTop:'20px'}}>
        <div className='q-card'>
          <p className='dark'>Can I spread the news of your wedding/May I bring a friend?</p>
          <p style={{lineHeight:'10pt'}}>-</p>
          <p style={{padding:'2%'}}>While we would love to have everyone we’ve known gather to celebrate this wonderful event, we do have limited seating and food. Please do not share the website with those not invited (it has sensitive information) or location and time with just anyone. If we’d want someone to view this page, we will share it with them! :)</p>
        </div>
      ...
      <div className='dual-column' style={{paddingTop:'20px', paddingBottom:'20px'}}>
        <div className='q-card'>
          <p className='dark'>What games will be held?</p>
          <p style={{lineHeight:'10pt'}}>-</p>
          <p style={{padding:'2%'}}>Games available to play will be cornhole, horseshoe, volleyball, oversized checkers, and spikeball! There will also be a basketball court, sidewalk track, and play areas for littles at the park! If you bring your own pole, you can fish in the lake. We will have two tables set up for checkers and chess as well.</p>
          <p style={{padding:'2%'}}>We would like to go outside and spend time together with our newly joined family, but if that doesn't permit we will stay inside and bring games in to play. No matter the weather, we will try having a cornhole tournament around 5 PM with a prize and trophy for the winning team!</p>
        </div>

        <div className='q-card'>
          <p className='dark'>When do I arrive?</p>
          <p style={{lineHeight:'10pt'}}>-</p>
          <p style={{padding:'2%'}}>We ask that the Wedding Party arrive by 10:30 AM to rehearse once more.</p>
          <p style={{padding:'2%'}}>Please may friends and family arrive by 1:30 PM (at the latest) to be seated before the ceremony. We would like you to sign in and grab bubbles on the way to your seat. There is only one available entryway so soon after the wedding party will begin lining up for the ceremony. Since we will have a packed day, we would like to begin on time.</p>
        </div>
        </div>
      </div>
    </div>
